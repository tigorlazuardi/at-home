...
export default function CV(prop: CVProps) {
	return (
		<div className={prop.className}>
			...
			<div className="flex justify-center items-center rounded-xl shadow-lg md:py-6 md:px-3 md:border-2 md:border-solid dark:shadow-none md:border-discord-200 lg-max:flex-wrap dark:bg-discord-800">
				<Profile iconSize={prop.iconSize} />
				<Bio age={prop.age} className="py-2 px-4 w-full grow md-max:mb-4 md-max:basis-full" />
			</div>
			<Experience className="mt-4 text-justify sm-max:px-2" />
		</div>
	)
}
